        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="{{ url('admin/services/addService') }}"><i class="fa fa-diamond"></i> <span class="nav-label">Services</span></a>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="{{ url('admin/services/addService') }}">Add service</a></li>
                        </ul>
                    </li>
                    <li>
